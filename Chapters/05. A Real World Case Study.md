...
%% Shared experts always receive input

U --> S1
U --> SD
U --> SN

%% Router selects Top-K routed experts
...
classDef shared fill:#CFE8B4,stroke:#5C8A3A,stroke-width:1.5px;
classDef routed fill:#DCE8F8,stroke:#4F6EA7,stroke-width:1.5px;
classDef router fill:#FCE8B2,stroke:#C98B00,stroke-width:1.5px;
classDef merge fill:#FFFFFF,stroke:#333333,stroke-width:2px;
