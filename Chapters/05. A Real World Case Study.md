...
subgraph Memory
    P[Procedural Memory<br/>• Agent Code<br/>• Model Parameters]
    E[Episodic Memory<br/>• Relevant Code<br/>• Examples<br/>• History]
    S[Semantic Memory<br/>• Code Base]
end
...
subgraph External
    D[Digital Environment<br/>• Code Interpreter<br/>• OS Platform]
    H[Dialogue<br/>• Human<br/>• Other Agents]
end
